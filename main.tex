...
{Emad Pourhassani\\ K.N. Toosi University of Technology\\emadpourhassani@gmail.com}
\title{Beamer example}
\subtitle{Usage of the theme \texttt{KNTUModern}}
...
\begin{frame}{Lists}
    ...
    \begin{itemize}
        \item
        Bullet lists are marked with a blue box.
    \end{itemize}
